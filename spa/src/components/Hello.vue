					...
					<div class="sections">
						...
						<section class="section section--current">
							...
							<div class="section__more">
								<div class="section__more-inner section__more-inner--bg1">
									<a href="#" class="section__more-link">
										<span class="section__more-linktext">Discover</span>
							...
							<ul class="section__facts">
								<li class="section__facts-item">
									<h3 class="section__facts-title">Work</h3>
									<span class="section__facts-detail">Website</span>
								</li>
								<li class="section__facts-item">
									<h3 class="section__facts-title">Client</h3>
									<span class="section__facts-detail">Alex Salicki</span>
								</li>
								<li class="section__facts-item">
									<h3 class="section__facts-title">Deadline</h3>
									<span class="section__facts-detail">2 weeks</span>
								</li>
						...
						<section class="section">
							...
							<div class="section__more">
								<div class="section__more-inner section__more-inner--bg2">
									<a href="#" class="section__more-link">
										<span class="section__more-linktext">Explore</span>
										<svg class="icon icon--arrowlong"><use xlink:href="#icon-arrowlong"></use></svg>
									</a>
								</div>
							</div>
						...
						<section class="section">
							...
							<ul class="section__facts">
								...
								<li class="section__facts-item">
									<h3 class="section__facts-title">Deadline</h3>
									<span class="section__facts-detail">4 weeks</span>
								</li>
						...
						<section class="section">
							...
							<ul class="section__facts">
								...
								<li class="section__facts-item">
									<h3 class="section__facts-title">Deadline</h3>
									<span class="section__facts-detail">3 weeks</span>
								</li>
